...
The interface and Discord Rich Presence languages are independent and persisted per user. English ships as the fallback; partial community translations are supported. See [the localization guide](docs/localization.md) to add a locale.
